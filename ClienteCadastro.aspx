<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ClienteCadastro.aspx.vb" Inherits="Talentos_ClienteCadastro" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Cliente - Talentos da Publicidade</title>
    ...
    <script>
        function ajustaTamanho() {
            try {
                parent.document.getElementById("FrameCadCliente").height = document.getElementById("PanDados").scrollHeight + 16;
            }
            catch (err) {
        ...
        function atualizaCombo() {
            // parent.document.location.reload(true);
            window.parent.atualizaComboCliente();
        }
    </script>
</head>
