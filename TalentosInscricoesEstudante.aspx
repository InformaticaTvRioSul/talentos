<%@ Page Title="" Language="VB" MasterPageFile="~/SiteTalentos/MasterPage.master" AutoEventWireup="false" CodeFile="TalentosInscricoesEstudante.aspx.vb" Inherits="SiteTalentos_TalentosInscricoesEstudante" %>
                ...
                <div class="table-responsive">
                    ...
                    <asp:GridView ID="GrdInscricoes" CssClass="table table-hover table-sm grid-inscricao my-4" runat="server" GridLines="None" CellSpacing="-1" AllowPaging="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="InsNomeEquipe" HeaderText="Nome da Equipe" />
                            <asp:BoundField DataField="InsResponsavel" HeaderText="Responsável" />
                            ...
                            <asp:TemplateField ShowHeader="False">
                                <ItemTemplate>
                                    <a href='TalentosInscricaoEstudante?Codigo=<%# DataBinder.Eval(Container.DataItem, "InsCodigo")%>' class="btn btn-outline-dark btn-sm float-right">Ver</a>
                                </ItemTemplate>
                                <ItemStyle Width="60px" />
                            </asp:TemplateField>
                        </Columns>
